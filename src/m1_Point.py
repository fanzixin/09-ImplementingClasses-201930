...
class Point(object):
    ...
    def move_to(self, x, y):
        """Put 'distance_traveled' ahead so that the x & y coordinate of 'self' won't be covered."""
        distance_traveled = self.get_distance_from(Point(x, y))
    ...
    def get_distance_from_start(self):
        distance = self.get_distance_from(Point(self.start_x, self.start_y))
        return distance
    ...
    def closer_to(self, point2, point3):
        ...
        distance3 = self.get_distance_from(point3)
